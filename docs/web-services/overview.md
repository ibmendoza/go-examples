...
Software development is ["anything goes"](https://itjumpstart.wordpress.com/2015/10/05/nature-of-software-development).

As such, I advocate a library-based approach to software development and opposed to 
[framework-driven](http://dave.cheney.net/2014/10/26/go-frameworks-and-ludditry) one.

In our example, I will adopt Nicolas Merouze's approach based on his article (see link below).
