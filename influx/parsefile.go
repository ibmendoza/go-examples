...
var file = flag.String("file", "", "JSON file")
...
func parse(v *jason.Value) {
	...
	for _, value := range slcObj {
		...
		timeInSeconds, err = obj.GetInt64("time")
...
func main() {
	...
	*/
	...
	if *file == "" {
		log.Fatal("Please specify name of JSON file")
	}
	...
	v, err = jason.NewValueFromReader(reader)
