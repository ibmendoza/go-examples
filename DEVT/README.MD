...
- [Separate configuration from app logic](https://github.com/crossplane/crossplane)
...
- [Separate RPC from app logic](https://github.com/dapr/docs/blob/master/concepts/service-invocation/README.md)
